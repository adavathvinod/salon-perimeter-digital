  ...
  return (
    <motion.div
      ...
      transition={{
        ...
        damping: 20,
        mass: 0.8,
        delay: phase === "line" ? index * 0.03 : phase === "circle" ? index * 0.02 : 0,
      }}
    >
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-background">
      ...
      >
        ...
        {/* Arc Content */}
        <motion.div
          className="absolute top-[10%] left-0 right-0 z-20 text-center pointer-events-none px-6"
        ...
        >
          ...
          <p className="mt-4 max-w-xl mx-auto text-muted-foreground text-sm md:text-base leading-relaxed">
            ...
            <br />
            Scroll through our curated collection of innovations.
          </p>
        </motion.div>
